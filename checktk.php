...
<div class="row">
  ...
  <div class="panel panel-primary">
    <div class="panel-heading">
      <h3 class="panel-title">Check Token Max Speed</h3>
    </div>
    <div class="panel-body">
      ...
      <div class="form-group">
        <button type="button" class="btn btn-primary" id="btn" onclick="checkLive()">Check Token</button>
  ...
  <div id="show" style="display: none;">
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title">Access Token Avatar</h3>
      </div>
      <div class="panel-body">
    ...
    <div class="panel panel-warning">
      <div class="panel-heading">
        <h3 class="panel-title">Access Token No Avatar</h3>
      </div>
      <div class="panel-body">
